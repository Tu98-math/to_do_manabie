...
extension TextBuilderExtension on String {
  ...
  _TextWidgetBuilder plain() {
    return _TextWidgetBuilder(this).color(Colors.black);
  }

  _TextWidgetBuilder bold() {
    return _TextWidgetBuilder(this).color(Colors.black).weight(FontWeight.w700);
  }
  ...
  Text text14(
      {FontWeight fontWeight = FontWeight.w400, Color color = Colors.black}) {
...
class _AppBarWidgetBuilder {
  ...
  AppBar build() {
    return AppBar(
      ...
      backgroundColor: _backgroundColor ?? AppColors.primary.blue,
...
extension AppBarBuilderExtension on String {
  _AppBarWidgetBuilder plainAppBar({Color color = Colors.white}) {
    return _AppBarWidgetBuilder(plain()
        .color(color)
